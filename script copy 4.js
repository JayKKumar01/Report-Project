...
function showImageSet(imageFileNames) {
    currentImageSet = imageFileNames.map(name => `items/${name}`);
...
// Example: Assigning images to an item and loading them
document.querySelector(".item-list li").addEventListener("click", () => {
    // Example: Each item has a set of associated images
    showImageSet(["1.jpg", "2.jpg", "3.jpg"]);
});
